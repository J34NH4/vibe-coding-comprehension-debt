class Solution:
    ...
    def _expand_around_center(self, input_string: str, left_index: int, right_index: int) -> str:
        """
        ...
        # Return the palindrome (adjust indices since loop went one step too far)
        return input_string[left_index + 1:right_index]