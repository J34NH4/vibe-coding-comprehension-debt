...
class Solution:
    def solveNQueens(self, n: int) -> List[List[str]]:
        ...
        Returns:
            List of all valid solutions, each solution is a list of strings
        ...
        self._solve_queens_recursive(n, 0, current_board, solutions)
        return solutions
    
    def _solve_queens_recursive(self, board_size: int, current_row: int, 
        ...
        Args:
            ...
            current_board: Current board state (column positions of queens)
        ...
        for column_position in range(board_size):
            if self._is_safe_position(current_board, current_row, column_position):
                ...
                self._solve_queens_recursive(board_size, current_row + 1, current_board, solutions)
    ...
    def _is_safe_position(self, current_board: List[int], target_row: int, target_column: int) -> bool:
        ...
        Args:
            ...
            target_row: Row to place the queen
            target_column: Column to place the queen
    ...
    def _convert_to_board_strings(self, queen_positions: List[int], board_size: int) -> List[str]:
        """
        Convert internal board representation to list of strings.
        
        Args:
            queen_positions: List where queen_positions[row] = column of queen
            board_size: Size of the chessboard
